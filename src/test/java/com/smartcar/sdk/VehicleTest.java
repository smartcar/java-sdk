...
public class VehicleTest {
  ...
  public void testPermission() throws Exception {
    ...
    PowerMockito.doReturn(res)
        .when(this.subject)
        .call("permissions", "GET", null, ApplicationPermissions.class);
  ...
  public void testHasPermission() throws Exception {
    String[] expectedPermissions =
        new String[] {"read_odometer", "read_vehicle_info", "read_location"};
    ResponsePaging paging = new ResponsePaging(10, 0);
    ApplicationPermissions expected = new ApplicationPermissions(paging, expectedPermissions);
    SmartcarResponse res = new SmartcarResponse<>(expected);
    ...
    Assert.assertTrue(
        this.subject.hasPermissions(new String[] {"read_odometer", "required:read_vehicle_info"}));
  }
  ...
  public void testDoesNotHavePermission() throws Exception {
    ...
    Assert.assertFalse(
        this.subject.hasPermissions(new String[] {"read_odometer", "read_vehicle_info"}));
  }
  ...
  public void testTirePressure() throws Exception {
    ...
    VehicleTirePressure expected =
        new VehicleTirePressure(frontLeft, frontRight, backLeft, backRight);
    String unitSystem = "metric";
    Date age = new Date();
    SmartcarResponse res = new SmartcarResponse<>(expected, unitSystem, age);
    ...
    JsonObject json =
        Json.createObjectBuilder()
            ...
            .add(
                "requests",
                Json.createArrayBuilder()
                    .add(Json.createObjectBuilder().add("path", "/sunroof").build())
                    .build())
            .build();
