 ...
 *
 * <p>But for the VehicleResponse class, we need to process that entire JSON response to the body
 * field. This method allows us to send the JSON data through the VehicleResponse constructor.
 */
