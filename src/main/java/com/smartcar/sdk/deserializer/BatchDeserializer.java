 ...
 *
 * <p>But for the BatchResponse class, we need to process that JSON response from /batch. This
 * method allows us to send the JSON data through the BatchResponse constructor.
 */
