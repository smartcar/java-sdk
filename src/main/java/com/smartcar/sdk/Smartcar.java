...
public class Smartcar {
   ...
   * @throws SmartcarException if the request is unsuccessful
   */
  public static VehicleIds getVehicles(String accessToken) throws SmartcarException {
   ...
   * </ol>
   *
   * @param compatibilityRequest with options for this request. See
   *     Smartcar.SmartcarCompatibilityRequest
   * @return A Compatibility object with isCompatible set to false if the vehicle is not compatible
   *     in the specified country and true if the vehicle is likely compatible.
   * @throws SmartcarException when the request is unsuccessful
   */
  public static Compatibility getCompatibility(SmartcarCompatibilityRequest compatibilityRequest)
      throws SmartcarException {
    ...
    if (compatibilityRequest.getTestModeCompatibilityLevel() != null) {
      urlBuilder.addQueryParameter(
          "testModeCompatibilityLevel", compatibilityRequest.getTestModeCompatibilityLevel());
    }
    HttpUrl url = urlBuilder.build();
    ...
    headers.put(
        "Authorization",
        Credentials.basic(
            compatibilityRequest.getClientId(), compatibilityRequest.getClientSecret()));
    Request request = ApiClient.buildRequest(url, "GET", null, headers);
  ...
  public static boolean verifyPayload(
      String applicationManagementToken, String signature, String payload)
      throws SmartcarException {
