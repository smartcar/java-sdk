...
### Gradle
```groovy
compile "com.smartcar.sdk:java-sdk:3.1.0"
```
...
### Jar Direct Download
* [java-sdk-3.1.0.jar](https://search.maven.org/remotecontent?filepath=com/smartcar/sdk/java-sdk/3.1.0/java-sdk-3.1.0.jar)
* [java-sdk-3.1.0-sources.jar](https://search.maven.org/remotecontent?filepath=com/smartcar/sdk/java-sdk/3.1.0/java-sdk-3.1.0-sources.jar)
* [java-sdk-3.1.0-javadoc.jar](https://search.maven.org/remotecontent?filepath=com/smartcar/sdk/java-sdk/3.1.0/java-sdk-3.1.0-javadoc.jar)

Signatures and other downloads available at [Maven Central](https://search.maven.org/artifact/com.smartcar.sdk/java-sdk/3.1.0/jar).
...
[javadoc-image]: https://img.shields.io/badge/javadoc-3.1.0-brightgreen.svg
