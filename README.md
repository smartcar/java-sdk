...
### Gradle
```groovy
compile "com.smartcar.sdk:java-sdk:4.8.1"
```
...
### Jar Direct Download
* [java-sdk-4.8.1.jar](https://repo1.maven.org/maven2/com/smartcar/sdk/java-sdk/4.8.1/java-sdk-4.8.1.jar)
* [java-sdk-4.8.1-sources.jar](https://repo1.maven.org/maven2/com/smartcar/sdk/java-sdk/4.8.1/java-sdk-4.8.1-sources.jar)
* [java-sdk-4.8.1-javadoc.jar](https://repo1.maven.org/maven2/com/smartcar/sdk/java-sdk/4.8.1/java-sdk-4.8.1-javadoc.jar)

Signatures and other downloads available at [Maven Central](https://central.sonatype.com/artifact/com.smartcar.sdk/java-sdk/4.8.1).
...
[javadoc-image]: https://img.shields.io/badge/javadoc-4.8.1-brightgreen.svg
