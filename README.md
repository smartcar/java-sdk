...
### Gradle
```groovy
compile "com.smartcar.sdk:java-sdk:4.6.0"
```
...
### Jar Direct Download
* [java-sdk-4.6.0.jar](https://repo1.maven.org/maven2/com/smartcar/sdk/java-sdk/4.6.0/java-sdk-4.6.0.jar)
* [java-sdk-4.6.0-sources.jar](https://repo1.maven.org/maven2/com/smartcar/sdk/java-sdk/4.6.0/java-sdk-4.6.0-sources.jar)
* [java-sdk-4.6.0-javadoc.jar](https://repo1.maven.org/maven2/com/smartcar/sdk/java-sdk/4.6.0/java-sdk-4.6.0-javadoc.jar)

Signatures and other downloads available at [Maven Central](https://central.sonatype.com/artifact/com.smartcar.sdk/java-sdk/4.6.0).
...
[javadoc-image]: https://img.shields.io/badge/javadoc-4.6.0-brightgreen.svg
